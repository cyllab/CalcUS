...
if (uc != null) {
this.getModelkit (false).cmdAssignMoveAtoms (bsSelected, iatom, this.ptNew, null, true);
...
var bsBasis = (isModelkit || !selectedOnly ? JU.BSUtil.copy (this.ms.am[this.ms.at[bsSelected.nextSetBit (0)].mi].bsAsymmetricUnit) : null);
...
if (isModelkit) {
this.getModelkit (false).cmdMinimize (eval, bsBasis, steps, crit, flags);
return;
