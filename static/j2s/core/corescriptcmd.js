...
if (!this.chk) try {
this.vwr.minimize (this.e, steps, crit, bsSelected, bsFixed, 0, (addHydrogen ? 16 : 0) | (isModelkit ? 256 : 0) | (selectedOnly ? 32 : 0) | (groupOnly ? 64 : 0) | (isSilent ? 1 : 0));
} catch (e1) {
...
break;
case 4129:
var nm = this.vwr.getModelkit (false).cmdAssignMoveAtoms (bs, index, pt, pts, true);
