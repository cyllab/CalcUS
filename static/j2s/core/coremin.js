...
bsFixed.or (this.vwr.getMotionFixedAtoms ());
...
return false;
}JU.Logger.info ("minimize: initializing " + this.pFF.name + " (steps = " + steps + " criterion = " + crit + ")" + " silent=" + this.isSilent + " quick=" + this.isQuick + " fixed=" + haveFixed + " bsSelected=" + bsSelected + " bsFixed=" + bsFixed + " bsFixedDefault=" + this.bsFixedDefault + " Xx=" + (bsXx != null) + " ...");
...
if (this.vwr.getModelkit (false).moveConstrained (a.i, this.p, true, true) > 0) {
doUpdateMinAtoms = true;
System.out.println ("minYes " + i + " " + this.p);
} else {
this.p.set (minAtom.coord[0], minAtom.coord[1], minAtom.coord[2]);
System.out.println ("minNot " + i + " " + this.p);
...
var a2 = this.dData[4];
this.calcs.setAngleVariables (this);
if (this.theta < 1) System.out.println ("UFFANGLE??");
