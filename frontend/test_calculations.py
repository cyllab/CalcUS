...
class XtbCalculationTests(CalculationUnitTest):
    ...
    def test_freq(self):
        self.assertTrue(self.run_test(type="Frequency Calculation",
            in_file="carbo_cation.mol", charge=1))

    def test_freq_solv_GBSA(self):
        self.assertTrue(self.run_test(type="Frequency Calculation",
            in_file="carbo_cation.mol", charge=1, solvent="Chloroform", solvation_model="GBSA"))

    def test_freq_solv_ALPB(self):
        self.assertTrue(self.run_test(type="Frequency Calculation",
            in_file="carbo_cation.mol", charge=1, solvent="Chloroform", solvation_model="ALPB"))

    def test_conf_search(self):
        self.assertTrue(self.run_test(type="Conformational Search", in_file="ethanol.sdf"))
    ...
    def test_conf_search_invalid_specification(self):
        self.assertFalse(self.run_test(type="Conformational Search", in_file="ethanol.sdf",
    ...
    def test_scan_distance(self):
        self.assertTrue(self.run_test(type="Constrained Optimisation",
    ...
    def test_NEB(self):
        self.assertTrue(self.run_test(type="Minimum Energy Path",
                in_file="elimination_substrate.xyz",
                aux_file="elimination_product.xyz",
                charge=-1, specifications="--nimages 3",
    ...
    def test_constrained_conf_search(self):
        ...
        self.assertTrue(self.run_test(type="Constrained Conformational Search",
            in_file="pentane.mol", constraints="Freeze/1_5_8;",
...
class OrcaCalculationTests(CalculationUnitTest):
    ...
    def test_sp_HF_CPCM(self):
        self.assertTrue(self.run_test(in_file="H2.mol2", solvation_model="CPCM",
                solvent="Methanol"))
    ...
    def test_sp_RIMP2(self):
        self.assertTrue(self.run_test(in_file="H2.sdf", theory_level="RI-MP2",
                basis_set="cc-pVDZ", specifications="cc-pVDZ/C"))
    ...
    def test_opt_DFT(self):
        self.assertTrue(self.run_test(type="Geometrical Optimisation", theory_level="DFT",
                method="M062X", callback=partial(self.cb_has_n_conformers, 1)))

    def test_opt_RIMP2(self):
        self.assertTrue(self.run_test(type="Geometrical Optimisation", in_file="H2.sdf",
            theory_level="RI-MP2", basis_set="cc-pVDZ", specifications="cc-pVDZ/C"))

    def test_opt_RIMP2_no_df(self):
        self.assertFalse(self.run_test(type="Geometrical Optimisation", in_file="H2.sdf",
            theory_level="RI-MP2", basis_set="cc-pVDZ"))

    def test_freq_SE(self):
        self.assertTrue(self.run_test(theory_level="Semi-empirical", method="PM3",
                type="Frequency Calculation", in_file="carbo_cation.mol", charge=1))

    def test_freq_HF(self):
        self.assertTrue(self.run_test(type="Frequency Calculation", in_file="carbo_cation.mol",
                charge=1))
    ...
    def test_ts_SE(self):
        self.assertTrue(self.run_test(theory_level="Semi-empirical", method="AM1",
                type="TS Optimisation", in_file="mini_ts.xyz",
                callback=partial(self.cb_has_n_conformers, 1)))

    def test_ts_HF(self):
        self.assertTrue(self.run_test(type="TS Optimisation", in_file="mini_ts.xyz",
                callback=partial(self.cb_has_n_conformers, 1)))
    ...
    def test_ts_RIMP2(self):
        self.assertTrue(self.run_test(theory_level="RI-MP2", basis_set="cc-pVDZ",
                type="TS Optimisation", in_file="mini_ts.xyz", specifications="cc-pVDZ/C",
                callback=partial(self.cb_has_n_conformers, 1)))

    def test_mo_HF(self):
        self.assertTrue(self.run_test(type="MO Calculation", in_file="carbo_cation.mol",
                charge=1))

    def test_mo_DFT(self):
        self.assertTrue(self.run_test(theory_level="DFT", method="M062X",
                type="MO Calculation", in_file="carbo_cation.mol", charge=1))

    def test_scan_distance_SE(self):
        self.assertTrue(self.run_test(theory_level="Semi-empirical", method="AM1",
                type="Constrained Optimisation", constraints="Scan_3.5_1.5_5/1_2;",
                callback=partial(self.cb_has_n_conformers, 5)))

    def test_scan_angle_SE(self):
        self.assertTrue(self.run_test(theory_level="Semi-empirical", method="AM1",
                type="Constrained Optimisation", constraints="Scan_120_130_10/1_2_3;",
                callback=partial(self.cb_has_n_conformers, 10)))

    def test_scan_dihedral_SE(self):
        self.assertTrue(self.run_test(theory_level="Semi-empirical", method="AM1",
                type="Constrained Optimisation", constraints="Scan_0_10_10/1_2_3_4;",
                callback=partial(self.cb_has_n_conformers, 10)))

    def test_freeze_distance_SE(self):
        self.assertTrue(self.run_test(theory_level="Semi-empirical", method="AM1",
                type="Constrained Optimisation", constraints="Freeze/1_4;",
                callback=partial(self.cb_has_n_conformers, 1)))

    def test_freeze_distance_SE2(self):
        self.assertTrue(self.run_test(theory_level="Semi-empirical", method="AM1",
                type="Constrained Optimisation", constraints="Freeze/1_4;Freeze/2_3;",
                callback=partial(self.cb_has_n_conformers, 1)))

    def test_freeze_angle_SE(self):
        self.assertTrue(self.run_test(theory_level="Semi-empirical", method="AM1",
                type="Constrained Optimisation", constraints="Freeze/1_2_3;",
                callback=partial(self.cb_has_n_conformers, 1)))

    def test_freeze_dihedral_SE(self):
        self.assertTrue(self.run_test(theory_level="Semi-empirical", method="AM1",
                type="Constrained Optimisation", constraints="Freeze/1_2_3_4;",
                callback=partial(self.cb_has_n_conformers, 1)))

    def test_nmr_DFT(self):
        self.assertTrue(self.run_test(theory_level="DFT", method="M062X",
                type="NMR Prediction", specifications="Def2/J"))
    ...
    def test_opt_DFT_tightscf(self):
        self.assertTrue(self.run_test(type="Geometrical Optimisation", theory_level="DFT",
                method="M062X", specifications="tightscf",
                callback=partial(self.cb_has_n_conformers, 1)))
...
class GaussianCalculationTests(CalculationUnitTest):
    ...
    def test_sp_DFT_SMD18(self):
        self.assertTrue(self.run_test(theory_level="DFT", method="M062X", solvation_model="SMD",
                solvent="Methanol"))

    def test_sp_DFT_SMD18(self):
        self.assertTrue(self.run_test(theory_level="DFT", method="M062X", solvation_model="SMD",
                solvation_radii="SMD18", solvent="Methanol"))
    ...
    def test_DFT_pop(self):
        self.assertTrue(self.run_test(theory_level="DFT",method="M062X", specifications="pop(NBO)"))
    ...
    def test_DFT_multiple_pop(self):
        self.assertTrue(self.run_test(theory_level="DFT",method="M062X", specifications="pop(esp)"))

        prop = Property.objects.latest('id')
        self.assertIn("ESP:", prop.charges)

    def test_DFT_pop_HLY(self):
        self.assertTrue(self.run_test(theory_level="DFT",method="M062X", specifications="pop(hly)"))
