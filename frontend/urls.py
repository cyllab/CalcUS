...
urlpatterns = [
    ...
    path("tour_restart/", views.tour_restart, name="tour_restart"),
    path("tour_done/", views.tour_done, name="tour_done"),
    ...
    path("conformer_table/", views.conformer_table, name="conformer_table"),
    ...
    path("receive_params/", views.receive_params, name="receive_params"),
